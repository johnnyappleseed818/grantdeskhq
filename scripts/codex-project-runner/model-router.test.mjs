...
const scenarios = [
  ...
  ["explicit GTM UI category", { title: "Adjust campaign workspace", category: "GTM_UI", description: "Bounded interface work." }, "gpt-5.6-terra", "medium", "STANDARD"],
  ["explicit UI category", { title: "Adjust workspace", category: "UI", description: "Bounded interface work." }, "gpt-5.6-terra", "medium", "STANDARD"],
  ["explicit frontend category", { title: "Adjust client workspace", category: "FRONTEND", description: "Bounded interface work." }, "gpt-5.6-terra", "medium", "STANDARD"],
