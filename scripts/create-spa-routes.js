...
const pages = [
  ...
  { route: "assessment", title: "Free First Award | GrantDeskHQ", description: "Try GrantDeskHQ with one award and evaluate a source-linked post-award reporting workflow before a subscription decision.", canonical: `${siteUrl}/assessment`, markup: `<main data-static-seo="true"><h1>Try GrantDeskHQ with one award for free.</h1><p>Use one appropriately redacted historical award to evaluate how a source-linked post-award workflow can organize reporting inputs and prepare a draft for professional review.</p><p>No subscription is required for the first award.</p></main>` },
