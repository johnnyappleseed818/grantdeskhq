...
type AnalyticsEventProperties = {
  surface?: "header" | "footer" | "pricing" | "resources" | "account";
  page_type?: "pricing";
  plan_key?: "essentials" | "growth" | "portfolio" | "starter" | "agency";
};
...
/**
 * Sends only a fixed, non-sensitive conversion name and optional allowlisted
 * metadata. It is a no-op until the visitor has explicitly granted analytics
 * consent; report, account, payment, and uploaded-file data never enters GA.
 */
...
function initializeGoogleAnalytics(measurementId: string) {
  ...
  // gtag.js consumes argument objects from dataLayer. Plain arrays look similar
  // in DevTools but are ignored by the Google tag, so retain the standard queue.
