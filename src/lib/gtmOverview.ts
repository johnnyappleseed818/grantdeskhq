...
export interface GtmOverview {
  ...
  partner: { health: GtmHealth; metrics: Record<string, GtmMetric>; sourceNote: string; };
...
const partners = ["researched", "highFit", "contactIdentified", "enrichmentReady", "emailVerified", "draftReady", "humanReview", "contacted", "replies", "activeConversations", "activatedPartners", "customersInfluenced", "paidCustomersInfluenced"];
