...
/**
 * Future partner discovery must consult the same immutable outreach ledger
 * before a research record can be treated as a first-touch candidate. This
 * helper only labels the record; it never imports, schedules, or sends.
 */
