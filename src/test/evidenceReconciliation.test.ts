  ...
  it("builds a KPI evidence index, confirms P6, and keeps a P2 source conflict visible", () => {
    ...
    const result: CompilationResult = {
      ...
      programChecks: [
        ...
        { id: "P6-MISSING", type: "kpi_result", title: "P6 — Average client satisfaction", detail: "The final client satisfaction result is required for this report.", action: "Add survey results.", owner: "Program", severity: "review", sources: [source], resolution: "open", status: "review" },
