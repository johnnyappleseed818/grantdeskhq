...
export const signalSources = [
  ...
  { name: "Reddit nonprofit discussions", type: "Pain research", status: "manual", cadence: "Manual research only", coverage: "Previously reviewed public threads; no scheduled fetches or API dependency", boundary: "No Reddit page crawling, API use, posting, commenting, messaging, contact discovery, or automated interaction.", url: "https://www.redditinc.com/policies/data-api-terms" },
  { name: "LinkedIn public discussions", type: "Social", status: "manual", cadence: "Manual research and drafting only", coverage: "Previously reviewed public posts and communities; no scheduled social actions", boundary: "No profile scraping, automated messaging, commenting, posting, or engagement.", url: "https://www.linkedin.com/help/linkedin/answer/a1341387/prohibited-software-and-extensions" },
  ...
  { name: "Competitor-intent search", type: "Competitor", status: "manual", cadence: "Manual research only", coverage: "Reviewed public category signals; no automated social search", boundary: "Anonymous or unresolved mentions remain research signals and cannot become outreach leads.", url: "https://grantdeskhq.com/gtm" }
] as const;
