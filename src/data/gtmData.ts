...
export const signalSources = [
  ...
  { name: "Reddit nonprofit communities", type: "Pain research", status: "restricted", cadence: "Manual / approved API", coverage: "10 reviewed threads in the current evidence set", boundary: "Commercial API approval is required before automated monitoring.", url: "https://www.redditinc.com/policies/data-api-terms" },
  { name: "LinkedIn public discussions", type: "Social", status: "manual", cadence: "Human review", coverage: "5 public posts and 3 professional communities", boundary: "No automated scraping, messaging, commenting, or engagement.", url: "https://www.linkedin.com/help/linkedin/answer/a1341387/prohibited-software-and-extensions" },
  ...
  { name: "Competitor-intent search", type: "Competitor", status: "configuration", cadence: "Not scheduled", coverage: "Instrumentl, Fluxx, Foundant, Blackbaud, Submittable, and Salesforce mentions", boundary: "Reviews without a verifiable organization cannot become outreach leads.", url: "https://grantdeskhq.com/gtm" }
] as const;
