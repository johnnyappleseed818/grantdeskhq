...
function setHeadMeta(attribute: "name" | "property", key: string, value: string) { const existing = Array.from(document.querySelectorAll<HTMLMetaElement>("meta[" + attribute + "]")).find((meta) => meta.getAttribute(attribute) === key); const meta = existing || document.createElement("meta"); meta.setAttribute(attribute, key); meta.setAttribute("content", value); if (!existing) document.head.appendChild(meta); }
...
export function BlogPostPage() {
  ...
  useEffect(() => {
    ...
    setHeadMeta("property", "og:url", "https://grantdeskhq.com/blog/" + post.slug);
