  ...
  return (
    <div className="site-shell py-14 lg:py-20">
      ...
      <div className="mt-12 grid gap-4 md:grid-cols-2">
        ...
        <PrivacyCard icon={MessagesSquare} title="Our AI-powered workflow receives only selected report context"><p>When you use our AI-powered workflow, GrantDeskHQ sends the selected files and authorized reporting facts to the OpenAI API with <code>store: false</code>. OpenAI states that API data is not used to train its models unless the customer explicitly opts in; standard abuse-monitoring logs may retain content for up to 30 days. <a className="font-semibold text-emerald-800 underline" href="https://developers.openai.com/api/docs/guides/your-data" target="_blank" rel="noreferrer">Read OpenAI’s API data controls</a>.</p></PrivacyCard>
        <PrivacyCard icon={UserCheck} title="Output from our AI-powered solution stays reviewable"><p>Important financial calculations are performed by application code. Draft statements keep source and review information, and a separate verification step checks material output against the selected evidence. Missing or conflicting information is shown for review instead of being silently approved.</p></PrivacyCard>
