  ...
  return (
    <div className="site-shell py-14 lg:py-20">
      ...
      <section className="mt-10 border-y border-slate-200 py-8">
        <h2 className="text-xl font-semibold text-navy-900">What the public prototype does not claim</h2>
        <p className="mt-3 max-w-4xl text-sm leading-7 text-slate-600">Because this is an early prototype, we are not claiming verified certifications, security assessments, particular technical controls, accounting-system integrations, production AI functionality, autonomous compliance decisions, or independently validated accuracy. The public site does not send reports to funders.</p>
      </section>
