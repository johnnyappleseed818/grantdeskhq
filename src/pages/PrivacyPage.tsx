  ...
  return (
    <div className="site-shell py-14 lg:py-20">
      <div className="max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-slate-600">Trust starts with plain language. The public GrantDeskHQ demo uses fictional information, does not accept client files, and keeps every reporting decision with a qualified professional.</p>
      </div>
      ...
      <div className="mt-12 grid gap-4 md:grid-cols-2">
        ...
        <PrivacyCard icon={MessagesSquare} title="Agree on data handling first"><p>Before an assessment starts, we’ll agree on which redacted historical examples to use and how they can be shared safely.</p></PrivacyCard>
