  ...
  return <section className="workspace-page">
    <div className="site-shell py-10 lg:py-14">
      <header className="workspace-header">
        ...
        <div className="workspace-actions"><Link className="button button-secondary" to="/contact"><MessageSquareText aria-hidden="true" />Feedback</Link><button type="button" className="button button-secondary" onClick={() => signOut()}><LogOut aria-hidden="true" />Sign out</button><Link className="button button-primary" to="/compile?new=1" reloadDocument><FilePlus2 aria-hidden="true" />New report</Link></div>
      </header>
