...
export const partnerDiscoverySchema = JSON.parse(`{"type":"object","additionalProperties":false,"required":["candidates"],"properties":{"candidates":{"type":"array","maxItems":30,"items":{"type":"object","additionalProperties":false,"required":["organization","organizationDomain","organizationUrl","sourceUrl","partnerType","whyFit","publicEmail","contact"],"properties":{"organization":{"type":"string"},"organizationDomain":{"type":"string"},"organizationUrl":{"type":"string"},"sourceUrl":{"type":"string"},"partnerType":{"type":"string"},"whyFit":{"type":"string"},"publicEmail":{"type":"string"},"contact":{"type":"object","additionalProperties":false,"required":["firstName","lastName","fullName","title","titleSourceUrl"],"properties":{"firstName":{"type":"string"},"lastName":{"type":"string"},"fullName":{"type":"string"},"title":{"type":"string"},"titleSourceUrl":{"type":"string"}}}}}}}}`);
