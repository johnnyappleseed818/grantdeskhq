...
export async function compileGrantReport(request: CompilationRequest): Promise<CompilationResult> {
  ...
  const profileEntries = Object.entries(compiled.grantProfile) as Array<[keyof typeof compiled.grantProfile, (typeof compiled.grantProfile)[keyof typeof compiled.grantProfile]]>;
